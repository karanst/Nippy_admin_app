        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              model.latitude != null || model.longitude != null || model.itemList![0].seller_latitude != null || model.itemList![0].seller_longitude != null ?
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Text(
                            calculateDistance(double.parse(model.latitude.toString()),
                            double.parse(model.longitude.toString()),
                            double.parse(model.itemList![0].seller_latitude.toString()),
                            double.parse(model.itemList![0].seller_longitude.toString())).toStringAsFixed(2) + 'Kms')),
                  ],
                ),
              )
              : SizedBox.shrink(),
          ...
          await Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => OrderDetail(
                ...
                id: model.id,
                distance: calculateDistance(double.parse(model.latitude.toString()),
                    double.parse(model.longitude.toString()),
                    double.parse(model.itemList![0].seller_latitude.toString()),
                    double.parse(model.itemList![0].seller_longitude.toString())).toStringAsFixed(2) + 'Kms'
              ),
