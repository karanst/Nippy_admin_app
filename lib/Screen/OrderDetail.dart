...
import 'package:eshopmultivendor/Screen/show_map.dart';
                      ...
                      child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ShowMap(model!, widget.distance)));
                          }),
                    )
                  ],
                )),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        orderItem.packagingCharge != null || orderItem.packagingCharge !=''?
                        Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.only(start: 5.0),
                                child: Text(
                                  CUR_CURRENCY + " " + (double.parse(orderItem.packagingCharge!)).toStringAsFixed(2),
                                  style: Theme.of(context)
                                      .textTheme
                                      .subtitle2!
                                      .copyWith(
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  orderItem.packagingCharge != null || orderItem.packagingCharge != ''?
                                  CUR_CURRENCY + " " + (double.parse(orderItem.price!) + double.parse(orderItem.packagingCharge!)).toStringAsFixed(2)
                                      : CUR_CURRENCY + " " + (double.parse(orderItem.price!)).toStringAsFixed(2),
                                  style: Theme.of(context)
                                      .textTheme
                                      .subtitle1!
