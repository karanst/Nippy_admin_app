...
const Color primary =Color(0xffFF9E4A) ;

const Color secondary = Color(0xff4B140A);
const Color fontColor = Color(0xff4543C1);
// const Color grad1Color = Color(0xff4B140A);
// const Color grad2Color = Color(0xffd4001d);
//const Color lightWhite2 = Color(0xffEEF2F3);
 const  grad1Color = Color(0xffFF9E4A);
  Color grad2Color = Color(0xffFF9E4A).withOpacity(0.6);
